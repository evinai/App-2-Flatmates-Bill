...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        # Insert Title
        pdf.set_font(family='Times', size=24, style='B')  # border=0 for no rectangle
        pdf.cell(w=0, h=80, txt="Flatmates Bill", border=1, align='C', ln=1)# w = 0 means rectangle takes entire length

        # Insert Period label and value
        pdf.set_font(family='Times', size=14, style='B')
        pdf.cell(w=100, h=25, txt='Period:', border=0) # add ln=1 to add under "March 2021"
        ...
        webbrowser.open('file://' + os.path.realpath(f"files/{self.filename}")) #for mac
